package com.moviemaker.image.video.slideimage.demo.demoopengl

import android.opengl.GLES30
import com.example.loanxu.openessldemo.demoopengl.GLRenderer
...
class Square {
    ...
    init {
        ...
        val vertexShader = GLRenderer.loadShader(
                GLES30.GL_VERTEX_SHADER,
                vertexShaderCode)
        val fragmentShader = GLRenderer.loadShader(
